...
import com.example.uigossip.commonComponents.IconComponentImageVector
import com.example.uigossip.commonComponents.SpacerWidth
import com.example.uigossip.data.Chat
import com.example.uigossip.data.chatList
import com.example.uigossip.ui.theme.Gray400
import com.example.uigossip.ui.theme.LightRed
import com.example.uigossip.ui.theme.LightYellow
import com.example.uigossip.ui.theme.Yellow
...
fun CustomTextField(
    ...
    TextField(
        ...
        trailingIcon = { CommonIconButtonDrawable(R.drawable.baseline_emoji_emotions_24) },
        modifier = modifier.fillMaxWidth(),
        shape = CircleShape
    )
